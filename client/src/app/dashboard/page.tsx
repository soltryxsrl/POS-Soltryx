    ...
    <div className="relative overflow-hidden rounded-3xl border border-white/20 bg-gradient-to-br from-brand-from via-brand-to to-brand-from px-7 py-6 text-white shadow-xl shadow-brand-from/30">
      ...
      <div className="relative flex flex-wrap items-end justify-between gap-4">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <Link
            href={sessionOpen ? '/dashboard/pos' : '/dashboard/cash'}
...
function QuickActions() {
  const actions: Array<{ href: string; label: string; icon: LucideIcon; tone: Tone }> = [
    { href: '/dashboard/pos', label: 'Nueva venta', icon: ScanLine, tone: 'brand' },
    { href: '/dashboard/products', label: 'Productos', icon: Package, tone: 'brand-alt' },
    { href: '/dashboard/inventory', label: 'Inventario', icon: Boxes, tone: 'emerald' },
    { href: '/dashboard/cash', label: 'Caja', icon: Wallet, tone: 'amber' },
    { href: '/dashboard/sales', label: 'Ventas', icon: Receipt, tone: 'slate' },
    { href: '/dashboard/reports', label: 'Reportes', icon: BarChart3, tone: 'brand' },
  ];
